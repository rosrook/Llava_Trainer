...
# Required data paths (edit for your server)
...
# Output (edit for your server)
OUTPUT_DIR="./checkpoints/llava-v1.5-7b-mydata-lora-small2399"

# Logging & experiment tracking
# Default: TensorBoard + Weights & Biases (run `wandb login` once on the machine). To disable W&B: REPORT_TO="tensorboard" and export WANDB_DISABLED=true
